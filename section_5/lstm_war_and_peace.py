...
print('Vectorization...')
# sentences_train = sentences[:int(len(sentences) * 0.75)]
# sentences_validation = sentences[int(len(sentences) * 0.75):]
...
model.fit(X, y, nb_epoch=5000, batch_size=256, callbacks=[checkpoint], validation_split=0.3)
